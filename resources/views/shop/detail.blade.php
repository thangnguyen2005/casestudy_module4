        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    @else
                        <button disabled class="btn btn-primary px-3" title="Hết hàng">
                            <i class="fas fa-shopping-cart"></i>
                            <button type="button" class="btn btn-sm text-dark p-0">
                                Hết hàng
                            </button>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="{{ route('detail', $product->id) }}" class="btn btn-sm text-dark p-0">
                            <i class="fas fa-eye text-primary mr-1"></i>Chi tiết
                        </a>
                        @if ($product->quantity > 0)
                            <a href="{{ route('add.to.cart', $product->id) }}" class="btn btn-sm text-dark p-0">
                                <i class="fas fa-shopping-cart text-primary mr-1"></i>Giỏ hàng
                            </a>
                        @else
                            <button disabled class="btn btn-sm text-dark p-0">
                                <i class="fas fa-shopping-cart text-primary mr-1"></i>Hết hàng
                            </button>
                        @endif
                    </div>
                </div>
